...
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2012-15 %s(PRO)"%(G,R,G,Y,B))
		print("%s [%s2%s]%s CRACK RANDOM FB ID 2011-13 %s(PRO)"%(G,R,G,Y,B))
		print("%s [%s3%s]%s CRACK RANDOM FB ID 2008-11 %s(PRO)"%(G,R,G,Y,B))
